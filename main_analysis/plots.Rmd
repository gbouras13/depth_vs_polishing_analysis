...
p1 <- plot_to_45("polypolish_errors", "Polypolish-default", FALSE, FALSE)
p2 <- plot_to_45("pypolca_errors", "pypolca-default", FALSE, TRUE)
p3 <- plot_to_45("polypolish_careful_errors", "Polypolish-careful", FALSE, FALSE)
p4 <- plot_to_45("pypolca_careful_errors", "pypolca-careful", FALSE, TRUE)
p5 <- plot_to_45("fmlrc2_errors", "FMLRC2", FALSE, FALSE)
p6 <- plot_to_45("hypo_errors", "HyPo", FALSE, TRUE)
...
jpeg(file = paste(plot_dir, "Figure3.jpeg", sep = "/" ), units = "in", 
     width = 9, 
     height = 16, bg = "transparent", res = 600)
...
jpeg(file = paste(plot_dir, "Supp_Figure1.jpeg", sep = "/" ), units = "in", 
     width = 9, 
     height = 16, bg = "transparent", res = 600)
