...
jpeg(file = paste(plot_dir, "SuppFig2.jpeg", sep = "/" ), units = "in", 
     width = 9, 
...
Make a dataframe with the error counts totaled over all 7 genomes (excluding the depths where E. coli and L. monocytogenes have problems with the automated Flye long read assemblies).
...
ymax <- 100
  ...
  jpeg(file = paste(plot_dir, "SuppFig3.jpeg", sep = "/" ), units = "in", 
     width = 9, 
     height = 16, bg = "transparent", res = 600)
